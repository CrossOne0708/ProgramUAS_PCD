...
# fill data
# fill_data = 
# fill_data.place(relx=0.7, rely=0.9, relwidth=0.3, relheight=0.1)
# canvas.create_window(0, 30, window=fill_data)
...
frame3.place(relx=0.864, rely=0.17, relwidth=0.1, relheight=0.07)
